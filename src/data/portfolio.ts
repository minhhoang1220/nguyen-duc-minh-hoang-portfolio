  ...
  en: {
    ...
    hero: {
      ...
      visual: {
        ...
        artifactStackLabel: "Specification ecosystem",
        desktopLabel: "Desktop/browser mockup",
        mobileLabel: "Mobile screen flow",
        tabletLabel: "LiveOps planning board",
        matrixLabel: "Matrix/table layout",
        noteLabel: "Functional spec notes",
        liveOpsLabel: "Game/LiveOps planning",
        visualTemplateLabel: "Visual mapping template",
        anonymizedLabel: "Sensitive details anonymized",
      },
  ...
  vi: {
    ...
    hero: {
      ...
      visual: {
        ...
        liveOpsLabel: "Game/LiveOps planning",
        visualTemplateLabel: "Visual mapping template",
        anonymizedLabel: "Chi tiết nhạy cảm đã ẩn danh",
      },
