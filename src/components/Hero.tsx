...
function Hero({ personal }: HeroProps) {
  return (
    <section
      id="home"
      className="relative overflow-hidden border-b border-line bg-cream py-14 md:py-20 lg:min-h-[calc(100vh-72px)] lg:py-24"
      aria-labelledby="hero-title"
    >
      <div className="container-main grid items-center gap-12 lg:grid-cols-[1.08fr_0.92fr] xl:gap-20">
        <div className="max-w-4xl">
          <p className="mb-5 text-xs font-semibold uppercase tracking-[0.14em] text-navy">{personal.name}</p>
          <p className="mb-7 max-w-2xl text-base font-medium leading-7 text-muted md:text-lg">{personal.roleLine}</p>
          <h1
            id="hero-title"
            className="max-w-4xl text-balance text-[42px] font-semibold leading-[1.02] text-navy md:text-[64px] lg:text-[72px] xl:text-[82px]"
          >
            {personal.tagline}
          </h1>
          <p className="mt-8 max-w-2xl text-base leading-8 text-ink md:text-lg">{personal.intro}</p>
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            <CvLink
              ...
              ariaLabel="Download Nguyễn Đức Minh Hoàng CV"
            >
              Download CV
            </CvLink>
            <a className="btn-ghost" href={personal.linkedin} aria-label="Open LinkedIn profile" target="_blank" rel="noreferrer">
              LinkedIn
            </a>
          </div>
        </div>

        <div className="hero-artifact-shell" aria-hidden="true">
          <div className="absolute left-5 top-5 h-24 w-24 border border-line bg-cream md:left-8 md:top-8" />
          <div className="floating-artifact relative z-10 grid h-full gap-4">
            <div className="artifact-card ml-auto w-[92%]">
            ...
            <div className="artifact-card ml-auto w-[80%]">
              <div className="mb-4 flex items-center justify-between">
            ...
            <div className="artifact-card w-[90%]">
              <div className="mb-4 flex items-center justify-between">
