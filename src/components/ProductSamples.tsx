    ...
    <section id="work-samples" className="section-padding bg-cream text-ink border-b border-line" aria-labelledby="work-samples-title">
      <div className="container-wide">
        ...
        <article className="mt-9 grid gap-7 rounded-lg border border-line bg-card p-5 shadow-minimal md:grid-cols-[0.34fr_0.66fr] md:p-7 hover:-translate-y-1 hover:border-navy/30 hover:shadow-hover transition duration-300">
          ...
          <div>
            <h3 className="text-[28px] font-semibold leading-[1.08] text-navy md:text-[38px] !text-wrap">
              {content.noteTitle}
            </h3>
            <p className="mt-6 max-w-none text-base leading-8 text-muted md:text-lg !text-wrap md:text-left">{content.notePreview}</p>
          </div>
        </article>
      </div>
    </section>
